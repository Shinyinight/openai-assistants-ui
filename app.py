...
def ask_openai():
    ...
    try:
        ...
        # Run assistant on thread assistant_id=os.environ.get('OPENAI_ASSISTANT_ID') 
        run = openai.beta.threads.runs.create(
        thread_id=thread_id,
        assistant_id="asst_fG1hFtScLVFdllgbb3om345k"
        )
...
# Configuration variables
    ...
    username = "User"   # Replace with the SSH password
    password = "1234"   # Replace with the SSH username
